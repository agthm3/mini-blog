            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="row align-items-center my-4">
                        <div class="col">
                            <h2 class="h3 mb-0 page-title">Artikel</h2>
                        </div>
                        <div class="col-auto">
                            ...
                            <a href="{{ route('blog.create') }}" class="btn btn-primary">
                                <span class="fe fe-filter fe-12 mr-2"></span>Create</a>
                        </div>
                    </div>
                    <!-- table -->
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small class="mb-0 text-muted">Ap #331-7123 Lobortis
                                                Avenue</small>
                                        </td>
                                        <td>
                                            <p class="mb-0 text-muted">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small class="mb-0 text-muted">287-8300 Nisl.
                                                St</small>
                                        </td>
                                        <td>
                                            <p class="mb-0 text-muted">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small class="mb-0 text-muted">Central African
                                                Republic</small>
                                        </td>
                                        <td class="text-muted">
                                            21/08/2019
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small class="mb-0 text-muted">P.O. Box 228, 7512
                                                Lectus Ave</small>
                                        </td>
                                        <td>
                                            <p class="mb-0 text-muted">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small class="mb-0 text-muted">Ap #377-5357 Sed
                                                Road</small>
                                        </td>
                                        <td>
                                            <p class="mb-0 text-muted">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small class="mb-0 text-muted">Ap #410-5363 Non,
                                                Avenue</small>
                                        </td>
                                        <td>
                                            <p class="mb-0 text-muted">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small class="mb-0 text-muted">8250 Molestie
                                                St.</small>
                                        </td>
                                        <td>
                                            <p class="mb-0 text-muted">
                                            ...
                                            <small class="mb-0 text-muted">British Indian Ocean
                                                Territory</small>
                                        </td>
                                        <td class="text-muted">
                                            30/03/2021
