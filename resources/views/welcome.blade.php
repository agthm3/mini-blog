...
<head>
    ...
    <title>TEST INI MASUK DI MINI <div class="modal fade" id="exampleModalToggle" aria-hidden="true"
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs"
                                    class="underline text-gray-900 dark:text-white">SEKARANG ADA DI MINI BLOG</a></div>
                        </div>
